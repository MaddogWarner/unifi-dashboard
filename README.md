...
- **URL feed** — plain HTTP/HTTPS feeds in netset, JSON, or JSONL format (FireHOL, Spamhaus DROP, or any compatible blocklist). The URL is validated and must be publicly reachable.
