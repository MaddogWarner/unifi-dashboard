...
export function CVEAlerts() {
  ...
  return (
    <div className="space-y-6">
      <header>
        <h1 className="text-2xl font-semibold text-slate-950">CVE Alerts</h1>
        <p className="mt-1 text-sm text-slate-500">Firmware exposure view for managed UniFi devices.</p>
      </header>
      ...
      <section className="rounded-md border border-slate-200 bg-white p-4">
        <h2 className="text-lg font-semibold text-slate-950">Device Inventory</h2>
